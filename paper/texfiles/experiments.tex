...
The first map we wish to test is a dead simple short and long path map inspired by the classic ACO Experiment mentioned in the Introduction (Section \ref{sec:introduction})